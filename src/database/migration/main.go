...
func main() {
	...
	//db.AutoMigrate(&model.Outlet2{}, &model.Program{}, &model.SpecialProgram{},
	//&model.Voucher{}, &model.CardType{}, &model.Employee{}, &model.MerchantCategory{},
	//&model.MerchantSocialMedia{}, &model.Merchant{}, &model.ProgramCard{}, &model.Reward{}, &model.TransactionMerchant{})
	db.AutoMigrate(&model.Outlet2{})
